...
const Dropdown = ({isOpen, toggle}) => {
    return (
        ...
        <div className={` flex flex-col space-y-2 ml-7 align-middle justify-center text-left my-auto pb-16 font-medium text-4xl transition-all duration-500 select-none' ${isOpen ? 'opacity-100 pointer-events-auto ' : 'transition-none h-0 -translate-y-2 opacity-0 pointer-events-none'}`} onClick={toggle}>
            <Link href='/'>
