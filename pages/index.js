  ...
  return (
    <div>
      ...
      <div className ='flex flex-col items-center justify-center mx-auto space-y-14 '>
        ...
        <div className='flex flex-col mx-auto w-4/5 md:w-2/3 lg:w-1/2 justify-center align-middle text-center pt-12 space-y-6 '>
          ...
          <div className='flex flex-col sm:flex-row align-middle justify-center space-x-8'>
            <Link href="mailto: contact@nabil.social" className=''>
              <div className='hover:cursor-pointer flex flex-row duration-300 align-middle justify-center whitespace-nowrap text-center w-1/2 sm:w-2/5 md:w-1/3  mt-12 border border-none rounded-lg bg-black py-4 text-white font-bold transform transition-all hover:scale-105'>
                <div className = 'mr-2 animate-wave'>👋 </div>
                <a className=' '>Say hello</a>
              </div> 
            </Link>
            <Link href='https://calendly.com/nabilchowdhury/intro'>
              <div className='hover:cursor-pointer duration-300 align-middle justify-center whitespace-nowrap text-center  w-1/2 sm:w-2/5 md:w-1/3   text-black mt-12 border border-none rounded-lg bg-[#f5f6fa] hover:bg-black py-4 hover:text-white font-bold transform transition-all hover:scale-105'>
